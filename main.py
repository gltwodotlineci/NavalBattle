...
def create_ships():
    ...
    for player in [player1, player2]:
        ...
        for n in range(1,2):
            ...
            for i in range(0,2):
                if i == 0:
                    begining_ship_x =  InteractConditions.coordinate_conditions(player.name, dimention_game, (i+1), "of the begining of yur ship "+str(n)+": ")#
                    begining_ship_y = InteractConditions.coordinate_conditions(player.name, dimention_game, (i+2), "of the begingin of yur ship "+str(n)+": ")
                else:
                    end_ship_x =  InteractConditions.coordinate_conditions(player.name, dimention_game, i, "of the end of yur ship "+str(n)+": ")
                    end_ship_y = InteractConditions.coordinate_conditions(player.name, dimention_game, (i+1), "of the end of yur ship "+str(n)+": ")
