...
class InteractConditions:
    ...
    def coordinate_conditions(name_player, dimention, integer, phrase):
        coordinate_choice = int(input(name_player+" Choose the coordinate "+str(integer)+" "+phrase+" "))# of your missile attack: 
        if -1 < coordinate_choice and coordinate_choice < dimention:
            ...
            while correct_coordinate == False:
                coordinate_choice = int(input("Carefull the ccordinate must be between 0 and "+str(dimention-1)+" choose the coordinate " +str(integer)+" "+phrase+" "))#  of your missile attack: 
